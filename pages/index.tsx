  ...
  return (
    ...
    >
      <div className='h-screen flex flex-col items-center justify-center gap-4'>
        ...
        <h1 className='text-6xl font-extrabold p-4'>Making Data Science Easy with DataHive. <br /><span className="flex flex-row gap-4">Start by uploading your dataset <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-16 h-16 animate-bounce">
